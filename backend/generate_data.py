...
if __name__ == "__main__":
    ...
    rzp_logs.to_csv("backend/rzp_logs.csv", index=False)
    bank_utrs.to_csv("backend/bank_utrs.csv", index=False)
    erp_df.to_csv("backend/erp_df.csv", index=False)
    print("CSVs written to backend/")
